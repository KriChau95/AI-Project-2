...
def read_results(file_path):
    ...
    return alpha_values, avg_blocked_cell_detects, avg_space_rat_pings, avg_movements

# Read data for bot1
alpha_1, blocked_1, pings_1, movements_1 = read_results(bot_1_results_file)

# Read data for bot2
alpha_2, blocked_2, pings_2, movements_2 = read_results(bot_2_results_file)
...
y_max = max(max(all_blocked), max(all_pings), max(all_movements))
