...
alpha_values = [0,0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14, 0.16, 0.18, 0.20, 0.22, 0.24, 0.26, 0.28, 0.30]
...
#                 curr_ship = copy.deepcopy(ships[i])
#                 # Capture all four returned values
#                 num_blocked_cell_detects, num_space_rat_pings, num_movements, timesteps = ship_moving.bot2(curr_ship, visualize, alpha, threshold=0.001)
